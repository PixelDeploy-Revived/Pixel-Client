...
public class FPS extends ModDraggable {
	...
	@Override
	public int getWidth() {
		return castOptionValueIntoBoolean("drawBackground") ? 54 : font.getStringWidth(Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap("60 FPS"));
	}
	...
	public void render(ScreenPosition pos) {
		String text = Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap(mc.getDebugFPS() + " FPS");
	...
	public void renderDummy(ScreenPosition pos) {
		String text = Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap("60 FPS");
