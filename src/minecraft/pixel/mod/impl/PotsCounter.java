...
public class PotsCounter extends ModDraggable {
	...
	@Override
	public int getWidth() {
		return castOptionValueIntoBoolean("drawBackground") ? 54 : font.getStringWidth(Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap("0 pots"));
	}
	...
	public void render(ScreenPosition pos) {
		...
		String text = Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap(potsCount + " pots");
	...
	public void renderDummy(ScreenPosition pos) {
		String text = Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap("0 pots");
