...
public class HealthIndicator extends ModDraggable {
	...
	@Override
	public int getWidth() {
		return castOptionValueIntoBoolean("drawBackground") ? 54 : font.getStringWidth(Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap("10 hearts"));
	}
	...
	public void render(ScreenPosition pos) {
		if (!mc.thePlayer.capabilities.isCreativeMode && !mc.thePlayer.isSpectator()) {
			String text = Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap(mc.thePlayer.getHealth() / 2 + " hearts");
	...
	public void renderDummy(ScreenPosition pos) {
		String text = Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap("10 hearts");
