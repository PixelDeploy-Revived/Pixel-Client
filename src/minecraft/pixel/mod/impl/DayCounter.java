...
public class DayCounter extends ModDraggable {
	...
	@Override
	public int getWidth() {
		return castOptionValueIntoBoolean("drawBackground") ? 54 : font.getStringWidth(Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap("365 days"));
	}
	...
	public void render(ScreenPosition pos) {
		String text = Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap(Long.valueOf(this.mc.theWorld.getWorldTime() / 24000L) + " days");
	...
	public void renderDummy(ScreenPosition pos) {
		String text = Brackets.fromIndex(castOptionValueIntoInt("brackets")).wrap("365 days");
