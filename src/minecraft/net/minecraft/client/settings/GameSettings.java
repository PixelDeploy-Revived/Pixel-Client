...
public class GameSettings
{
    ...
    public KeyBinding keyBindModPositioning = new KeyBinding("Mod Positioning", Keyboard.KEY_RSHIFT, "Pixel Client");
    public KeyBinding keyBindFreelook = new KeyBinding("Freelook", Keyboard.KEY_F, "Pixel Client");
    public KeyBinding keyBindFullbright = new KeyBinding("Fullbright", Keyboard.KEY_L, "Pixel Client");

    public GameSettings(Minecraft mcIn, File optionsFileIn)
    {
        this.keyBindings = (KeyBinding[])((KeyBinding[])ArrayUtils.addAll(new KeyBinding[] {this.keyBindAttack, this.keyBindUseItem, this.keyBindForward, this.keyBindLeft, this.keyBindBack, this.keyBindRight, this.keyBindJump, this.keyBindSneak, this.keyBindSprint, this.keyBindDrop, this.keyBindInventory, this.keyBindChat, this.keyBindPlayerList, this.keyBindPickBlock, this.keyBindCommand, this.keyBindScreenshot, this.keyBindTogglePerspective, this.keyBindSmoothCamera, this.keyBindStreamStartStop, this.keyBindStreamPauseUnpause, this.keyBindStreamCommercials, this.keyBindStreamToggleMic, this.keyBindFullscreen, this.keyBindSpectatorOutlines, keyBindModPositioning, keyBindFreelook, keyBindFullbright}, this.keyBindsHotbar));
