...
public class GuiConnecting extends GuiScreen
{
    ...
    {
    	GuiDisconnected.lastIP = ip;
    	GuiDisconnected.lastPort = port;
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    Pixel.getInstance().getDiscord().update("In Game", "Playing on " + ip);
                }
                catch (UnknownHostException unknownhostexception)
                {
                    ...
                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected("connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[] {"Unknown host"})));
                }
                catch (Exception exception)
                {
                    ...
                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected("connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[] {s})));
                }
            }
        }).start();
    }
