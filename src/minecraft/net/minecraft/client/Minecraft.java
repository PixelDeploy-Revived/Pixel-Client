...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        Pixel.getInstance().drawSplashScreen(renderEngine);
        this.initStream();
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(Pixel.getDisplayName());
    ...
    public void shutdownMinecraftApplet()
    {
        try
        {
        	Pixel.getInstance().getDiscord().shutdown();
    ...
    public void displayInGameMenu()
    {
        if (this.currentScreen == null)
        {
            this.displayGuiScreen(new pixel.gui.GuiIngameMenu());
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        Pixel.getInstance().getDiscord().update("In Game", "Playing in " + worldName);
    }
